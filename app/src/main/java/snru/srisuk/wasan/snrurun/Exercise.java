...
public class Exercise extends AppCompatActivity {
    ...
    private int timessAnInt = 1, chooseAnInt, scoreAnInt=0, amount, answerTrue;
    ...
    public void clickAnswre(View view) {

        if (!checkRandio()) {

            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this, "ยังไม่ได้เลือกคำตอบ", "โปรดเลือกคำตอบด้วย");


        } else if (timessAnInt == 6) {
            MyAlert myAlert = new MyAlert();
    ...
    private void changeView(int index) {
        ...
        textView.setText( Integer.toString(timessAnInt)+ questionStrings[index]);
    ...
    private void bindWidget() {
        ...
        radioGroup = (RadioGroup) findViewById(R.id.ragChice);
